<#***************************************************************
Retorno: Descriptografa a chave do SQL Server no Registro do Windows
Autor: Tiago Crespi
Data: 06/2024
Version: 1.0 
Obs: Necessário rodar como Administrador
***************************************************************#>

# Usar no SQL Server 2016-2019
# No parametro, acessar o Regedit e colocar como está em: HKEY_LOCAL_MACHINE -> SOFTWARE -> MICROSOFT -> MICROSOFT SQL SERVER -> MSSQL[NUMVERSAO].[INSTANCIA]

function GetSqlServerProductKey($InstanceName="MSSQL14.MSSQLSERVER") {
